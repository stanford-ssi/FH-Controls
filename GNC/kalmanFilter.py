...
def kalman_filter(x, u, Z, A, B, dt, engine_length, P):
    ...
    v = np.array([0.5*dt*dt, 0.5*dt*dt, 0.5*dt*dt, dt, dt, dt, -0.5*dt*dt*engine_length, -0.5*dt*dt*engine_length, -0.5*dt*dt*engine_length, -dt*engine_length, -dt*engine_length, -dt*engine_length,]).T
